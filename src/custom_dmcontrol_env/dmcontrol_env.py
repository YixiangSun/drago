...
from custom_dmcontrol_env import cheetah, walker
...
class DefaultDictWrapper(gym.Wrapper):
	...
	def step(self, action):
		...
		return obs, reward, 0, truncated, defaultdict(float, info)
...
def make_env(cfg):
	...
	env = suite.load(domain,
					 task,
					 task_kwargs={'random': cfg.seed, 'time_limit': cfg.time_limit},
